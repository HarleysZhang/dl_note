...
![densenet-block结构图](../images/densenet/densenet-block结构图.png)
...
![densenet对比实验结果](../images/densenet/densenet对比实验结果.png)
...
![densenet系列网络参数表](../images/densenet/densenet系列网络参数表.png)
